...
-- Create article categories table if it doesn't exist
...
DROP POLICY IF EXISTS "Categories are viewable by everyone" ON article_categories;
DROP POLICY IF EXISTS "Admin full access to articles" ON articles;
DROP POLICY IF EXISTS "Admin full access to categories" ON article_categories;
