/*
  # Fix puzzle progress function parameters

  1. Changes
    - Update function signature to match frontend calls
...
-- Create updated function with correct parameters
...
BEGIN
  ...
  -- Get existing progress with a single query
  SELECT 
    rating,
    current_streak,
    highest_streak,
